    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#website_line" data-toggle="tab">网址统计</a></li>
...
//                        'endInputOptions' => ['value' => '2017-07-20'],
                        ...
                        'pluginEvents' => [
                            "apply.daterangepicker" => "function(start,end,label) {var v=$('.range-value').html(); self.location='/statistics/website?range='+v;}",
    ]
                    ]);
                    ?>
                </li>
            ...
            <div class="tab-content no-padding">
                <div class="tab-pane active" id="website_line">
                    <?=
                    Highcharts::widget([
                        'scripts' => [
                            'highcharts-more',
