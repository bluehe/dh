...
class m161223_030824_create_system_table extends Migration {
    ...
    public function up() {
        ...
        $this->batchInsert($table, ['id', 'parent_id', 'code', 'tag', 'type', 'store_range', 'store_dir', 'value', 'sort_order'], [
            ...
            [406, 4, 'repair_image', '报修图片', 'radio', '{"1":"不允许上传","2":"允许上传"}', '', '1', 6],
            [407, 4, 'repair_wechat_send', '微信消息', 'checkbox', '{"1":"创建","2":"受理","3":"派工","4":"维修","5":"评价"}', '', '', 7],
            [408, 4, 'business_accept', '报修受理', 'radio', '{"1":"派工","2":"受理"}', '', '1', 8],
            [409, 4, 'business_dispatch', '派工设置', 'radio', '{"1":"全部","2":"匹配"}', '', '2', 9],
            [410, 4, 'business_repairupdate', '报修修改', 'radio', '{"1":"允许","2":"不允许"}', '', '1', 10],
        ]);
    }
