...
class m140506_102106_rbac_init extends \yii\db\Migration {
    ...
    public function up() {
        ...
        $this->batchInsert($authManager->itemTable, ['name', 'type', 'description', 'rule_name', 'data', 'created_at', 'updated_at'], [
            ...
            ['/business/suggest-business', '2', null, null, null, '1482820123', '1482820123'],
            ...
            ['/work/pickup-work', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/pickup-close', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/pickup-view', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/pickup-export', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/suggest-work', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/suggest-view', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/suggest-reply', '2', null, null, null, '1482820123', '1482820123'],
            ['/work/suggest-export', '2', null, null, null, '1482820123', '1482820123'],
            ...
            ['/statistics/suggest', '2', null, null, null, '1482820123', '1482820123'],
            ['admin', '1', '超级管理员', null, null, '1482820123', '1482820123'],
            ['manager', '1', '系统管理员', null, null, '1482820123', '1482820123'],
            ['manager_forum', '1', '楼苑管理员', null, null, '1482820123', '1482820123'],
            ...
            ['repair_admin', '1', '报修审核员', null, null, '1482820123', '1482820123'],
            ...
            ['拾物管理', '2', '拾物管理', null, null, '1482820123', '1482820123'],
            ['投诉管理', '2', '投诉管理', null, null, '1482820123', '1482820123'],
            ...
            ['投诉统计', '2', '投诉统计', null, null, '1482820123', '1482820123'],
        ]);
        $this->batchInsert($authManager->itemChildTable, ['parent', 'child'], [
            ...
            ['拾物管理', '/work/pickup-work'],
            ['拾物管理', '/work/pickup-close'],
            ['拾物管理', '/work/pickup-view'],
            ['拾物管理', '/work/pickup-export'],
            ['投诉管理', '/work/suggest-work'],
            ['投诉管理', '/work/suggest-reply'],
            ['投诉管理', '/work/suggest-view'],
            ['投诉管理', '/work/suggest-export'],
            ['楼苑概况', '/work/building'],
            ['教职工管理', '/work/teacher'],
