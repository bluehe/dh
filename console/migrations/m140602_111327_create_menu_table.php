...
class m140602_111327_create_menu_table extends \yii\db\Migration {
    ...
    public function up() {
        ...
        $this->batchInsert($menuTable, ['id', 'name', 'parent', 'route', 'order', 'data'], [
            ...
            [33, '楼苑概况', 30, '/work/building', 3, '{"icon":"fa fa-building-o"}'],
            [34, '教职工管理', 30, '/work/teacher', 4, '{"icon":"fa fa-users","multi-action":[ "teacher", "teacher-create","teacher-update"]}'],
            [35, '学生管理', 30, '/student/student', 5, '{"icon":"fa fa-graduation-cap","multi-action":[ "student", "student-create","student-update"]}'],
