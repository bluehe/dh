...
class AppAsset extends AssetBundle {
    ...
    public function init() {
        ...
        } elseif (($controller_id == 'forum' && ($action_id == 'room-create' || $action_id == 'room-update' || $action_id == 'bed-create' || $action_id == 'bed-update')) || ($controller_id == 'repair' && ($action_id == 'worker' || $action_id == 'worker-create' || $action_id == 'worker-update')) || ($controller_id == 'work' && ($action_id == 'teacher' || $action_id == 'teacher-create' || $action_id == 'teacher-update')) || $controller_id == 'student') {
