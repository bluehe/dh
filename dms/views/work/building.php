        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="target_tl target_room">
                    <div class="col-md-1 col-xs-1 text-center label-danger">关闭</div>
                    <div class="col-md-1 col-xs-1 text-center label-default">启用</div>
                    <div class="col-md-1 col-xs-1 text-center label-warning">住满</div>
                    <div class="col-md-1 col-xs-1 text-center label-info">未住满</div>
                </div>
                <div class="target_tl target_stat hide">
                    <div class="col-md-1 col-xs-1 text-center bg-red">关闭</div>
                    <div class="col-md-1 col-xs-1 text-center bg-info">预订</div>
                    <div class="col-md-1 col-xs-1 text-center bg-blue">住宿</div>
                                        ...
                                        <?php if ($broom['sroom']) { ?>
                                            ...
                                            <div class="col-md-<?= count($broom['sroom']) ?> col-xs-<?= count($broom['sroom']) * 3 ?> clearspace">
                                                <div class="broom row clearspace text-center ">
                                                    <h4 class="text_ellipsis col-xs-12 <?= $broom['stat'] == Room::STAT_CLOSE ? 'label-primary' : 'label-default' ?>"><?= $broom['name'] ?></h4>
                                                                    ...
                                                                    <div class="bed_content">
                                                                        ...
                                                                        <?php if (isset($sroom['bed']) && $sroom['bed']) { ?>
                                                                            <?php foreach ($sroom['bed'] as $bed) { ?>
                                                                                <div data-stat="<?= $bed['stat'] == Bed::STAT_OPEN ? (isset($total['bed_student'][$bed['id']]) ? 'bg-blue' : 'bg-gray') : 'bg-red' ?>" style="<?= count($sroom['bed']) > 5 ? 'height:50%;width:' . (100 / ceil(count($sroom['bed']) / 2)) . '%' : 'height:100%;width:' . (100 / count($sroom['bed'])) . '%' ?>"><?= $bed['name'] ?></div>
                                                                            <?php } ?>
                                                                        <?php } else { ?>
                                                    ...
                                                    <div class="bed_content">
                                                        ...
                                                        <?php if (isset($broom['bed']) && $broom['bed']) { ?>
                                                            <?php foreach ($broom['bed'] as $bed) { ?>
                                                                <div data-stat="<?= $bed['stat'] == Bed::STAT_OPEN ? (isset($total['bed_student'][$bed['id']]) ? 'bg-blue' : 'bg-gray') : 'bg-red' ?>" style="<?= count($broom['bed']) > 5 ? 'height:50%;width:' . (100 / ceil(count($broom['bed']) / 2)) . '%' : 'height:100%;width:' . (100 / count($broom['bed'])) . '%' ?>"><?= $bed['name'] ?></div>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                                            <div style="border:none;float:none;line-height: 30px;font-size: 14px;">无</div>
                                                        <?php } ?>
