...
$this->title = '投诉统计';
$this->params['breadcrumbs'][] = ['label' => '数据统计', 'url' => ['suggest']];
    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#suggest_line" data-toggle="tab">趋势</a></li>
                <li><a href="#suggest_type" data-toggle="tab">类型</a></li>
                <li><a href="#suggest_evaluate" data-toggle="tab">评价</a></li>
...
<!--                    <button type="button" class="btn btn-default pull-right" id="daterange-btn"><span><i class="fa fa-calendar"></i> 时间选择</span><i class="fa fa-caret-down"></i></button>-->
                    ...
                    DateRangePicker::widget([
                        ...
                        'pluginEvents' => [
                            "apply.daterangepicker" => "function(start,end,label) {var v=$('.range-value').html(); self.location='/statistics/suggest?range='+v;}",
                        ]
                    ]);
                    ?>
                </li>
            ...
            <div class="tab-content no-padding">
                <div class="tab-pane active" id="suggest_line">
                    <?=
                    Highcharts::widget([
                        'scripts' => [
                            'highcharts-more',
                ...
                <div class="tab-pane row" id="suggest_type">
                ...
                <div class="tab-pane row" id="suggest_evaluate">
