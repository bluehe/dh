...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">DMS</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
                                        ...
                                        <li>
                                            ...
                                            <ul class="menu">
                                                <li> start message
                                                    <a href="#">
                                                        <div class="pull-left">
                                                            <img src="<?= $directoryAsset ?><?= Yii::$app->user->identity->avatar ? Yii::$app->user->identity->avatar : '/image/user.png' ?>" class="img-circle"
                                                                 alt="User Image"/>
                                                        </div>
                                                        <h4>
                                                            Support Team
